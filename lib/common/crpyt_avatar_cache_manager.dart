...
/// 缓存管理
class CrpytAvatarCacheManager extends CacheManager {
  static const key = 'libCrpytCachedImageData';

  static CrpytAvatarCacheManager _instance;
  factory CrpytAvatarCacheManager() {
    _instance ??= CrpytAvatarCacheManager._();
    return _instance;
  }

  CrpytAvatarCacheManager._() : super(Config(key, fileService: CrpytHttpFileService()));
}
